...
while ($linhas = $sql->fetch()) {
  ...
  <div class="aviso" id="aviso_$id">
    ...
    <a href=\"carrinho.php?id_pacote=$id\">
      <button class="botao" onclick="enviar_id("' . $id . '","' . $valor . '","' . $nome . '")" id="comprar">comprar</button>
    </a>
...
function pnss(id) {
  ...
  function enviar_id(x,y,z){
    window.open("adicionaraocarrinho.php?id_pacote="+x+"&valor="+y+"&nome="+z,"_self");
  }
</script>
</html>